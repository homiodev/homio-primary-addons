...
public class ClusterConfiguration extends ShareConfiguration {
  ...
  private final Map<Integer, ClusterAttributeConfiguration> attributeConfigurations = new HashMap<>();
  ...
  public void addAttribute(ClusterAttributeConfiguration attributeConfiguration) {
    attributeConfigurations.put(attributeConfiguration.getAttributeID(), attributeConfiguration);
  }

  public @NotNull ClusterAttributeConfiguration getAttributeConfiguration(int attributeID) {
    return attributeConfigurations.computeIfAbsent(attributeID, integer ->
        new ClusterAttributeConfiguration(attributeID, this));
  }
}

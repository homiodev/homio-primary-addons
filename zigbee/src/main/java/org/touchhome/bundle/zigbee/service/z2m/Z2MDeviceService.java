...
import static org.touchhome.bundle.zigbee.util.Z2MDeviceDTO.UNKNOWN_TYPE;
...
import org.touchhome.bundle.zigbee.service.z2m.properties.dynamic.Z2MGeneralProperty;
import org.touchhome.bundle.zigbee.service.z2m.properties.dynamic.Z2MPropertyUnknown;
...
public class Z2MDeviceService {
    ...
    private void createOrUpdateDeviceGroup() {
        ...
        entityContext.var().createGroup("zigbee", this.deviceEntity.getEntityID(), groupName, true,

...
/**
 * BleApplication class is the starting point of the entire Peripheral service's structure. It is responsible of the service's publishment and and the advertisement.
 */
public class BleApplication implements GattApplication1 {
  ...
  /**
   * Set the alias name of the peripheral. This name is visible by the central that discover s peripheral. This must set before start to take effect.
   */
